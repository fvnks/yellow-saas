export const PURCHASE_CONFIG = {
  areas: [
    ...
    { value: 'VERTIKAL', label: 'Vertikal', color: 'bg-violet-50 text-violet-700 border border-violet-200' },
...
export const SALES_CONFIG = {
  ...
  sellers: [
    { value: 'FELIPE', label: 'Felipe', color: 'bg-indigo-50 text-indigo-700 border border-indigo-200' },
    { value: 'MACA', label: 'Maca', color: 'bg-purple-50 text-purple-700 border border-purple-200' },
  ],
  ivaRate: 0.19,
} as const;
