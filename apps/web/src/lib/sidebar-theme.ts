...
export const MODULE_SIDEBAR_THEMES: Record<ModuleType, ModuleSidebarTheme> = {
  dashboard: {
    ...
    inactiveBadgeClass: 'bg-amber-500/20 text-slate-900 border-amber-500/30 font-extrabold',
    avatarClass: 'bg-amber-500/20 text-amber-400 border-amber-500/40',
  },
  condominio: {
    ...
    inactiveBadgeClass: 'bg-cyan-500/20 text-slate-900 border-cyan-500/30 font-extrabold',
  ...
  proyectos: {
    ...
    inactiveBadgeClass: 'bg-purple-500/20 text-slate-900 border-purple-500/30 font-extrabold',
  ...
  micuenta: {
    ...
    inactiveBadgeClass: 'bg-blue-500/20 text-slate-900 border-blue-500/30 font-extrabold',
  ...
  admin: {
    ...
    activeSubItemText: 'text-amber-400',
    groupActiveText: 'text-amber-400',
    activeBadgeClass: 'bg-amber-600/80 text-slate-950 border-amber-500/40 font-black',
    inactiveBadgeClass: 'bg-amber-500/20 text-slate-900 border-amber-500/30 font-extrabold',
    avatarClass: 'bg-amber-500/20 text-amber-400 border-amber-500/40',
  },
  restaurante: {
