...
export const MODULE_SIDEBAR_THEMES: Record<ModuleType, ModuleSidebarTheme> = {
  ...
  admin: {
    ...
    headerBadgeBg: 'bg-violet-500/10',
    headerBadgeText: 'text-violet-400',
    headerBadgeBorder: 'border-violet-500/20',
    activeBorderClass: 'border-violet-500',
    iconActiveColorClass: 'text-violet-400',
    backIconColorClass: 'text-violet-400',
    activeSubItemText: 'text-violet-400',
    groupActiveText: 'text-violet-400',
    activeBadgeClass: 'bg-violet-500 text-white border-violet-400 font-black',
    inactiveBadgeClass: 'bg-violet-500/20 text-violet-300 border-violet-500/30 font-extrabold',
    avatarClass: 'bg-violet-500/20 text-violet-300 border-violet-500/40',
  },
  restaurante: {
