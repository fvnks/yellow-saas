...
export class ApiClient {
  ...
  async createInvoice(data: { order_id?: string; customer_id?: string; invoice_date: string; due_date?: string; payment_method?: string; document_type?: 'boleta' | 'factura'; items: { product_id: string; quantity: number; unit_price: number; discount?: number; description?: string }[] }) {
