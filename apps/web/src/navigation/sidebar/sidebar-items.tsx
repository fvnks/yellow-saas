    ...
    items: [
      {
        ...
        subItems: [
          ...
          { title: "列表as de Material", path: "/dashboard/inventory/boms", icon: "ClipboardList" },
          { title: "Reporte Stock", path: "/dashboard/inventory/stock-report", icon: "FileBarChart" },
          { title: "Reorden", path: "/dashboard/inventory/reorder", icon: "TrendingUp" },
          { title: "Etiquetas", path: "/dashboard/inventory/label-designer", icon: "Tag" },
          { title: "Forecast", path: "/dashboard/inventory/forecast", icon: "TrendingUp", comingSoon: true },
          { title: "Multi-Moneda", path: "/dashboard/inventory/multi-currency", icon: "DollarSign", comingSoon: true },
          { title: "Tipo de Cambio", path: "/dashboard/inventory/exchange-rates", icon: "ArrowLeftRight", comingSoon: true },
          { title: "Valorización", path: "/dashboard/inventory/valuation", icon: "CircleDollarSign", comingSoon: true },
        ],
      },
      {
        title: "Bodegas",
    ...
    items: [
      {
        ...
        icon: "ShoppingCart",
        subItems: [
          { title: "Órdenes", path: "/dashboard/sales", icon: "ShoppingCart" },
          { title: "Nueva Orden", path: "/dashboard/sales/new", icon: "ShoppingCart" },
          { title: "Cotizaciones", path: "/dashboard/sales/quotations", icon: "FileText", comingSoon: true },
          { title: "Guias de Despacho", path: "/dashboard/sales/delivery", icon: "Truck", comingSoon: true },
          { title: "Facturas", path: "/dashboard/sales/invoices", icon: "Receipt", comingSoon: true },
          { title: "Devoluciones", path: "/dashboard/sales/returns", icon: "ArrowLeftRight", comingSoon: true },
