    ...
    items: [
      {
        ...
        subItems: [
          ...
          { title: "Cotizaciones", path: "/dashboard/sales/quotations", icon: "FileText" },
          { title: "Guias de Despacho", path: "/dashboard/sales/delivery", icon: "Truck" },
          { title: "Facturas", path: "/dashboard/sales/invoices", icon: "Receipt" },
          { title: "Devoluciones", path: "/dashboard/sales/returns", icon: "ArrowLeftRight" },
