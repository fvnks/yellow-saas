    ...
    items: [
      {
        ...
        subItems: [
          ...
          { title: "Serialización", path: "/dashboard/inventory/serials", icon: "ClipboardList" },
          { title: "Lotes", path: "/dashboard/inventory/batches", icon: "Boxes" },
          { title: "Devoluciones", path: "/dashboard/inventory/returns", icon: "ArrowLeftRight" },
          { title: "Importar", path: "/dashboard/inventory/import", icon: "ClipboardList" },
          { title: "Categorías", path: "/dashboard/inventory/categories", icon: "Tag" },
          { title: "Variantes", path: "/dashboard/inventory/variants", icon: "Package" },
          { title: "UdM", path: "/dashboard/inventory/uom", icon: "Package" },
          { title: "Tags", path: "/dashboard/inventory/tags", icon: "Tag" },
          { title: "Reservas", path: "/dashboard/inventory/reservations", icon: "ClipboardList" },
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { title: "Nuevo", path: "/dashboard/suppliers/new", icon: "Truck" },
        ],
      },
    ],
  },
    ...
    items: [
      {
        ...
        subItems: [
          ...
          { title: "Asignacion", path: "/dashboard/projects/allocation", icon: "Users" },
        ],
      },
    ],
  },
