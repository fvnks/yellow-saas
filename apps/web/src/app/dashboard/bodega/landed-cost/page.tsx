...
export default function LandedCostPage() {
 ...
 <p className="text-sm text-muted-foreground mt-1">Fletes, seguros, aranceles y otros costos de importacion</p>
 </div>
 </div>
 ...
 <th className="text-left px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">ID</th>
 <th className="text-left px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Orden Compra</th>
 ...
 <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-semibold ${costTypeConfig[a.cost_type]?.color || 'bg-muted text-foreground'}`}>
