...
export default function BodegaPage() {
 ...
 <Link href="/dashboard/inventory/stock-report" className="bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1.5 transition-colors">
 <Package className="w-4 h-4" /> Valorizaci�n
 </Link>
 <Link href="/dashboard/inventory/config" className="bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1.5 transition-colors">
 <Settings className="w-4 h-4" /> Configurar
 </Link>
 {activeTab === 'products' && (
 <>
 <button onClick={() => setShowScanner(true)} className="bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-3 py-2 rounded-lg text-sm font-medium flex items-center gap-1.5 transition-colors">
 ...
 {activeTab === 'alerts' && (
 <button onClick={loadAll} className="bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors">
 ...
 ss.variant === 'warning' ? 'bg-peach/30 text-[#c64d00] border border-peach' :
 ...
 <td className="px-4 py-3 text-center">
 <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-semibold ${
 a.status === 'out_of_stock' ? 'bg-rose-50 text-rose-700 border border-rose-200' : 'bg-peach/30 text-[#c64d00] border border-peach'
