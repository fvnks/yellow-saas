...
const initialCustomers = [
  ...
  { id: '4', code: 'CUST-004', name: 'Retail Sur SA', tradeName: 'Retail Sur', taxId: '65.432.109-8', phone: '+56 4 234 5678', email: 'contacto@retail.cl', address: 'Av. La Costa 456', city: 'ValparaÃ­so', region: 'ValparaÃ­so', paymentTerms: 15, creditLimit: 1200000, currentBalance: 200000, priceListId: 'pl-3', taxExempt: false, status: 'active' },
  ...
  { id: '7', code: 'CUST-007', name: 'Construcciones Beta', tradeName: 'Beta Construcciones', taxId: '32.109.876-5', phone: '+56 32 234 5678', email: 'info@beta.cl', address: 'å·· Rua 654', city: 'Antofagasta', region: 'Antofagasta', paymentTerms: 45, creditLimit: 2000000, currentBalance: 0, priceListId: 'pl-1', taxExempt: false, status: 'active' },
  { id: '8', code: 'CUST-008', name: 'MecÃ¡nica Alfa', tradeName: 'Alfa MecÃ¡nica', taxId: '21.098.765-4', phone: '+56 2 234 5679', email: 'ventas@alfa.cl', address: 'Calle Lira 987', city: 'Santiago', region: 'Metropolitana', paymentTerms: 60, creditLimit: 600000, currentBalance: 600000, priceListId: 'pl-3', taxExempt: false, status: 'active' },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">GestiÃ³n de clientes y contacto comercial</p>
        </div>
              ...
              {filteredCustomers.map((customer, index) => {
                ...
                return (
                  <TableRow key={customer.id}>
                    ...
                    <TableCell className="text-center font-medium">{customer.paymentTerms} dÃ­as</TableCell>
