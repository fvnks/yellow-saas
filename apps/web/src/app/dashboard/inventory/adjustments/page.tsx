    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-900">Ajustes de Stock</h1>
            <p className="text-sm text-slate-500 mt-1">Historial de ajustes manuales de inventario</p>
          </div>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-slate-200">
                    ...
                    <th className="text-left px-6 py-3 text-[9px] font-semibold text-slate-500 uppercase tracking-wider">Motivo</th>
                    ...
                    return (
                      <tr key={a.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-6 py-3">
                          <p className="text-xs font-medium text-slate-900">{a.product?.name}</p>
                          <p className="text-[9px] text-slate-500">{a.product?.sku}</p>
                        </td>
                        <td className="px-6 py-3 text-xs text-slate-700">{a.warehouse?.name}</td>
                        <td className="px-6 py-3 text-xs text-slate-500 max-w-[200px] truncate">{a.notes || '—'}</td>
