...
export default function DeadStockReport() {
 ...
 className="bg-card border border-border rounded-lg px-3 py-1.5 text-xs focus:outline-none bg-card border-border text-white focus:ring-2 focus:ring-primary/20">
