    ...
    <div className="space-y-4">
      ...
      {showCreate && (
        <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-medium text-slate-700">Crear Conversion</span>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="text-xs text-slate-700">Unidad base</span>
            </label>
          </div>
      ...
      {conversions.length === 0 ? (
        <div className="text-center py-12 bg-slate-50 border border-dashed border-slate-300 rounded-xl">
          ...
          <p className="text-xs text-slate-400">Sin conversiones de unidades configuradas</p>
        </div>
      ) : (
        <div className="space-y-4">
