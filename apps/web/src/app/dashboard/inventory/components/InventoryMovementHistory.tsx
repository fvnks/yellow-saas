...
export default function InventoryMovementHistory() {
 ...
 className="px-3 py-1 bg-card border border-border rounded-lg hover:bg-muted bg-card border-border hover:bg-primary/90 disabled:opacity-50 transition-colors">
 Anterior
 </button>
