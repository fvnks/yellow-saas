...
export default function SupplierCatalogImport() {
 ...
 const res = await fetch(`/api/companies/${companyId}/supplier-catalogs`);
 if (res.ok) {
 ...
 return (
 <div key={c.id} className="flex items-center justify-between p-3 bg-card border border-border rounded-xl bg-primary border-border">
 <div className="flex items-center gap-3">
