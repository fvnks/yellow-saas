...
export default function ProductKits({ productId }: ProductKitsProps) {
 ...
 min={0.01} step={0.01}
 className="w-24 bg-card border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-card border-border text-white"
 placeholder="Cant." />
 ...
 return (
 <div key={kit.id} className="bg-card border border-border rounded-xl p-4 bg-primary border-border">
