...
export default function JournalEntryDetailPage() {
 ...
 if (!confirm('Publicar este asiento?')) return;
 try {
 const api = getApiClient();
 ...
 if (!confirm('Revertir este asiento?')) return;
 try {
 const api = getApiClient();
 ...
 className="bg-card border border-border hover:bg-red-50 text-red-600 bg-card border-border hover:bg-red-500/10 text-red-400 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
 Revertir
 </button>
 )}
 </div>
