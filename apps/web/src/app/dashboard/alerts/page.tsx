...
export default function AlertsPage() {
 ...
 <Link href="/dashboard" className="p-2 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors">
 <ArrowLeft className="w-5 h-5" />
 </Link>
 <div>
 <h1 className="text-xl font-bold text-foreground">Alertas de Stock</h1>
 <p className="text-sm text-muted-foreground mt-1">Productos por debajo del stock minimo</p>
 </div>
 </div>
 ...
 <p className="text-sm text-muted-foreground">Todo en orden. Sin alertas de stock.</p>
 </div>
 ) : (
 ...
 <th className="text-center px-6 py-3 text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Stock Actual</th>
 <th className="text-center px-6 py-3 text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Stock Minimo</th>
 ...
 <td className="px-6 py-3 text-center text-xs text-muted-foreground">{item.min_stock}</td>
 <td className="px-6 py-3 text-center">
 ...
 <h3 className="text-sm font-semibold text-foreground">Lotes Vencidos ({expiredBatches.length})</h3>
 </div>
 <div className="overflow-x-auto">
 <table className="w-full">
 <thead>
