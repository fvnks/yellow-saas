      ...
      {showManager && (
        <div className="bg-card border border-border rounded-xl p-4 dark:bg-primary dark:border-border space-y-4">
          ...
          <div className="border-t border-border pt-3">
            <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Nuevo Campo</span>
            <div className="grid grid-cols-2 gap-2 mt-2">
              <input type="text" value={newField.name} onChange={e => setNewField({ ...newField, name: e.target.value })}
                className="bg-muted border border-border rounded-lg px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-primary/20"
              ...
              {newField.field_type === 'select' && (
                <input type="text" value={newField.options} onChange={e => setNewField({ ...newField, options: e.target.value })}
                  className="col-span-2 bg-muted border border-border rounded-lg px-2 py-1.5 text-xs focus:outline-none focus:ring-1 focus:ring-primary/20"
