...
export default function RentabilidadReport({ project, costs, expenses, timesheets }: RentabilidadProps) {
 ...
 <button onClick={handleExportPDF} className="bg-card border border-border hover:bg-muted text-foreground px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors">
