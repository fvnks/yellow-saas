...
export default function NewProjectPage() {
 ...
 ]).then(([customersRes, usersRes, ccRes]) => {
 ...
 <Link href="/dashboard/projects">
 <button type="button" className="bg-card border border-border hover:bg-muted text-foreground px-4 py-2 rounded-lg text-sm font-medium transition-colors">
 Cancelar
 </button>
 </Link>
