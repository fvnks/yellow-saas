...
export default function NuevoPedidoPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-xl font-bold text-foreground">Nuevo Pedido Interno</h1>
        <p className="text-sm text-muted-foreground mt-1">Solicitar productos para una bodega</p>
      </div>
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-1">
              <label className="block text-xs font-medium text-foreground">Bodega Destino *</label>
                  ...
                  <tr key={index} className="border-b border-border hover:bg-muted transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <input type="number" min="1" value={item.quantity}
                        ...
                        className="w-full bg-muted border border-border rounded-lg px-3 py-2 text-sm text-foreground text-center focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-transparent" />
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      <button type="button" onClick={() => removeItem(index)} disabled={items.length === 1}
                        className="p-1.5 text-muted-foreground hover:text-rose-600 hover:bg-rose-50 rounded transition-colors disabled:opacity-40">
