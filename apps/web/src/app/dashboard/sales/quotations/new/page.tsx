  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-900">Nueva Cotización de Venta</h1>
          <p className="text-sm text-slate-500 mt-1">Crear una nueva cotización para un cliente</p>
        </div>
      </div>
