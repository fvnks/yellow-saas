...
export default function EditSalePage() {
  ...
  const addItem = () => {
    setItems(prev => [...prev, { product_id: '', quantity: 1, unit_price: 0, discount_percent: 0 }]);
  };
  ...
  const getLineTotal = (item: OrderItem) => {
    ...
    return subtotal - (subtotal * item.discount_percent) / 100;
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href={`/dashboard/sales/${id}`} className="p-2 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-xl font-bold text-foreground">Editar Venta</h1>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-right px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase tracking-wider w-28">Total Línea</th>
                      ...
                      <tr key={index} className="border-b border-border hover:bg-muted transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <input
                            ...
                            onChange={(e) => handleItemChange(index, 'discount_percent', parseInt(e.target.value) || 0)}
                            className="w-full bg-muted border border-border rounded-lg px-3 py-2 text-sm text-foreground text-center focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-transparent transition-colors"
                          />
                        </td>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-1">
                  <label className="block text-xs font-medium text-foreground">Notas de la Orden</label>
                  <textarea
            ...
            <Card className="sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-col gap-2 pt-4">
                  ...
                  <Link href={`/dashboard/sales/${id}`} className="w-full">
