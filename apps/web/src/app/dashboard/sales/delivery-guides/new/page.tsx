...
export default function NewDeliveryGuidePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/dashboard/sales/delivery-guides');
    } catch (err: unknown) {
  ...
  return (
    <div className="space-y-6">
      <button onClick={() => router.push('/dashboard/sales/delivery-guides')} className="flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
        <ArrowLeft className="w-4 h-4" /> Volver a Guías de Despacho
      </button>
            ...
            <Card className="sticky top-24">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex flex-col gap-2 pt-4">
                  ...
                  <Link href="/dashboard/sales/delivery-guides" className="w-full">
