...
export default function InvoiceDetailPage({ params }: { params: { id: string } }) {
 ...
 {/* Document */}
 <div className="bg-card border border-border rounded-xl shadow-sm bg-primary border-border print:shadow-none print:border-0 print:rounded-none" id="print-area">
