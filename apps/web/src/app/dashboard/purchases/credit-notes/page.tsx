  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-foreground">Notas de Crédito de Compra</h1>
          <p className="text-sm text-muted-foreground mt-1">Documentos de crédito recibidos de proveedores</p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-5">
          <p className="text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Total Notas de Crédito</p>
          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={6} className="px-4 py-12 text-center text-sm text-muted-foreground">No hay notas de crédito registradas</td></tr>
              ) : notes.map(n => (
