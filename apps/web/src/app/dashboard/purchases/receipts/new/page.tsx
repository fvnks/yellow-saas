...
export default function NewGoodsReceiptPage() {
 ...
 className="flex-1 bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-4 py-2 rounded-lg text-sm font-medium transition-colors">
 Volver
 </button>
