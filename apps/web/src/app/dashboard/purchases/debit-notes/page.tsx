    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-white border border-slate-200 rounded-xl p-5">
          <p className="text-[9px] font-semibold text-slate-500 uppercase tracking-wider">Total Notas de Débito</p>
          ...
          <table className="w-full">
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={6} className="px-4 py-12 text-center text-sm text-slate-400">No hay notas de débito registradas</td></tr>
              ) : notes.map(n => (
