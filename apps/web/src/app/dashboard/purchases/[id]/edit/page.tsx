  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <Link href={`/dashboard/purchases/${id}`} className="p-2 text-muted-foreground hover:text-foreground hover:bg-muted rounded-lg transition-colors">
          <ArrowLeft className="w-5 h-5" />
        </Link>
        <div>
          <h1 className="text-xl font-bold text-foreground">Editar Orden de Compra</h1>
          <p className="text-sm text-muted-foreground mt-1">Modificar datos de la orden</p>
        </div>
      </div>
