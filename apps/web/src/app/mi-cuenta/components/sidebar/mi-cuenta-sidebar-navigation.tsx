...
export default function MiCuentaSidebarNavigation({ sidebarItems }: MiCuentaSidebarNavigationProps) {
 ...
 <span className="absolute right-3 text-[9px] font-mono font-bold text-slate-500 bg-cloud/80 px-1.5 py-0.5 rounded">⌘K</span>
 )}
 </div>
 ...
 itemActive
 ? "bg-cloud text-white font-bold border-l-4 border-amber-500 shadow-sm shadow-amber-500/10"
