      ...
      {activeTab === 'consultas' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/consultas" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Consulta
            </Link>
          </div>
      ...
      {activeTab === 'vacunas' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/vacunas" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Vacuna
            </Link>
          </div>
          {loadingVaccinations ? (
      ...
      {activeTab === 'cirugias' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/cirugias" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Cirugía
            </Link>
          </div>
          {loadingSurgeries ? (
      ...
      {activeTab === 'hospitalizacion' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/hospitalizaciones" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Internación
            </Link>
          </div>
      ...
      {activeTab === 'evoluciones' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/evoluciones" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Nota SOAP
            </Link>
          </div>
          {loadingEvolutions ? (
      ...
      {activeTab === 'recetas' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/recetas" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nueva Receta
            </Link>
          </div>
      ...
      {activeTab === 'laboratorio' && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/veterinaria/laboratorio" className="bg-amber-500 hover:bg-[#EAB308] text-slate-950 font-bold px-3 py-1.5 rounded-xl text-[11px] flex items-center gap-1 shadow-sm">
      ...
      {activeTab === 'imagenologia' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/imagenologia" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nuevo Estudio
            </Link>
          </div>
          {loadingImaging ? (
      ...
      {activeTab === 'pagos' && (
        <div className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 pb-3">
            ...
            <Link href="/veterinaria/pagos" className="bg-[#0F172A] text-white text-xs font-bold px-3 py-1.5 rounded-xl hover:bg-slate-800 transition-all">
              + Nuevo Pago
            </Link>
          </div>
          {loadingPayments ? (
