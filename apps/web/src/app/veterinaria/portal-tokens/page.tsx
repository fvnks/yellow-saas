...
export default function PortalTokensPage() {
 ...
 <button onClick={() => setShowModal(true)} className="bg-monday-violet hover:bg-monday-violet-hover text-ink font-bold px-4 py-2.5 rounded-xl text-sm transition-all shadow-sm flex items-center gap-2 active:scale-[0.98]">
