...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-slate-100 dark:bg-slate-950/80 dark:border-slate-800">
      ...
      <div
        className={cn(
          'md:hidden overflow-hidden transition-all duration-300 border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-950',
