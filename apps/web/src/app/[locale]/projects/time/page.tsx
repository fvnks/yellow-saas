...
export default function ProjectTimePage() {
 ...
 <div>
 <h1 className="text-xl font-bold text-foreground">Registro de Tiempo</h1>
 <p className="text-sm text-muted-foreground mt-1">Control de tiempo por proyecto</p>
 </div>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Timer Activo</p>
 <p className="text-2xl font-bold text-foreground mt-1">{activeTimers.length}</p>
 </div>
 ...
 <Pause className="w-6 h-6 text-monday-violet" />
 </div>
 </div>
 </div>
 </div>
