...
export default function VeterinaryPatientsPage() {
 ...
 name: '',
 clientId: '',
 species: 'perro' as Species | string,
 breed: '',
 ...
 >
 {(speciesList.length > 0 ? speciesList : [{ id: 'perro', key: 'perro', name: 'Perro' }, { id: 'gato', key: 'gato', name: 'Gato' }]).map((sp: any) => (
