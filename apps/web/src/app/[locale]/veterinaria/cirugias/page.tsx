...
import InformedConsentModal from '@/app/veterinaria/cirugias/components/informed-consent-modal';
import { useSurgeries } from '@/app/veterinaria/hooks/use-surgeries';
