...
import { usePharmacyStock, usePharmacyDispenses } from '@/app/veterinaria/hooks/use-pharmacy';
...
export default function VeterinaryPharmacyPage() {
 ...
 const cartTotal = cartItems.reduce((a, c) => a + c.quantity * (c.item.sale_price_clp || c.item.unit_price_clp || 0), 0);
 ...
 {showModal && (
 <div className="fixed inset-0 z-50 bg-cloud backdrop-blur-xs flex items-center justify-center p-4 overflow-y-auto">
