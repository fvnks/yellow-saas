...
export default function ImagingPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#0F172A] via-slate-900 to-blue-950 rounded-2xl p-6 text-white shadow-md relative overflow-hidden border border-slate-800">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button onClick={handleCreate} disabled={!form.patient_id || !form.client_id}
                  className="bg-[#0F172A] hover:bg-slate-800 text-white font-medium px-5 py-2 rounded-xl text-sm transition-all disabled:opacity-50">
                  Crear Estudio
                </button>
              </div>
            </div>
