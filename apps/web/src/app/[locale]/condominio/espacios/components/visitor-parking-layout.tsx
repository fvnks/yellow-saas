...
export default function VisitorParkingLayout() {
 ...
 editMode
 ? 'bg-monday-violet text-slate-950 hover:bg-amber-400'
 ...
 <div className="bg-cloud text-amber-300 font-black text-center text-xs py-1 px-2 rounded-lg tracking-widest border border-slate-700 shadow-xs">
 ...
 {parkingModalSpot && (
 <div className="fixed inset-0 bg-cloud/60 backdrop-blur-xs z-50 flex items-center justify-center p-4">
 ...
 <button
 type="submit"
 className="px-4 py-2 rounded-xl text-xs font-bold bg-cloud text-white hover:bg-cloud"
 >
 Crear Sector
 </button>
 </div>
