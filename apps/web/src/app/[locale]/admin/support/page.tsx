...
export default function AdminSupportPage() {
 ...
 selectedTicket.status === s ? 'bg-cloud text-white' : 'bg-card text-muted-foreground hover:text-white'
 }`}
 >
 ...
 <div className="bg-cloud border border-border rounded-xl p-6 space-y-4 max-h-[500px] overflow-y-auto">
 {loadingDetail ? (
 ...
 <div className="bg-cloud border border-border rounded-xl p-4 flex items-center gap-4">
 ...
 <div className="bg-cloud border border-border rounded-xl p-4">
 ...
 className="px-4 py-2 bg-cloud hover:bg-slate-700 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50 flex items-center gap-2"
 >
 ...
 <button type="submit" disabled={saving} className="px-4 py-2 bg-cloud hover:bg-slate-700 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50">
 ...
 onClick={() => setFilter(f)}
 className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
 filter === f ? 'bg-cloud text-white' : 'bg-card text-muted-foreground hover:text-white hover:bg-slate-700'
 }`}
 >
 ...
 <div className="bg-cloud border border-border rounded-xl overflow-hidden">
