...
const MODULE_OPTIONS = [
 ...
 { id: 'accounting_pro', label: 'Contabilidad Pro', icon: Package, color: 'text-monday-violet bg-amber-50 border-amber-200' },
 ...
 { id: 'restaurant', label: 'Restaurante', icon: Package, color: 'text-monday-violet bg-amber-50 border-amber-200' },
