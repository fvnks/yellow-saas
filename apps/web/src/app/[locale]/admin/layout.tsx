...
export default function AdminLayout({ children }: { children: ReactNode }) {
 ...
 className="w-full bg-cloud border border-mist text-xs text-ink placeholder:text-iron rounded-xl pl-8 pr-7 py-1.5 focus:outline-none focus:border-violet-600/60 focus:ring-1 focus:ring-violet-600/40 transition-all"
 />
 {searchQuery ? (
 ...
 className="text-iron hover:text-ink transition-colors p-1 rounded-lg hover:bg-cloud"
 >
 ...
 <Link
 href="/dashboard"
 className="text-xs font-semibold text-ink hover:text-ink transition-all px-3.5 py-1.5 rounded-xl bg-cloud hover:bg-mist border border-mist shadow-sm"
 >
 Ir al ERP
 </Link>
 </div>
