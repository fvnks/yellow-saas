...
export default function AdminLayout({ children }: { children: ReactNode }) {
 ...
 {/* Brand Header */}
 <div className="p-3 border-b border-mist/80 bg-cloud">
 ...
 className="w-full bg-cloud border border-mist text-xs text-slate-200 placeholder:text-slate-500 rounded-xl pl-8 pr-7 py-1.5 focus:outline-none focus:border-violet-600/60 focus:ring-1 focus:ring-violet-600/40 transition-all"
 />
 {searchQuery ? (
 ...
 >
 <Icon className={`w-4 h-4 shrink-0 ${active ? 'text-violet-400' : 'text-iron'}`} />
 ...
 {/* User footer */}
 {sidebarOpen && (
 <div className="p-3 border-t border-mist bg-snow">
 ...
 className="text-iron hover:text-white transition-colors p-1 rounded-lg hover:bg-cloud"
 >
 ...
 <Link
 href="/dashboard"
 className="text-xs font-semibold text-ink hover:text-white transition-all px-3.5 py-1.5 rounded-xl bg-cloud hover:bg-slate-700 border border-slate-700 shadow-sm"
 >
 Ir al ERP
 </Link>
 </div>
