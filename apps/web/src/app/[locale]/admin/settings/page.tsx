...
export default function AdminSettingsPage() {
 ...
 className="px-4 py-2 bg-cloud hover:bg-slate-700 rounded-lg text-sm font-medium text-white transition-colors"
 >
 ...
 <div className="bg-cloud border border-border rounded-xl shadow-xl w-full max-w-md mx-4">
 <div className="px-6 py-4 border-b border-border flex items-center justify-between">
 ...
 editForm.is_active ? 'bg-cloud' : 'bg-muted'
 }`}
 >
 ...
 type="submit"
 disabled={editSaving}
 className="px-4 py-2 bg-cloud hover:bg-slate-700 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50"
 >
 ...
 {deleteAdmin && (
 <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
 <div className="bg-cloud border border-border rounded-xl shadow-xl w-full max-w-sm mx-4">
 <div className="px-6 py-4 border-b border-border flex items-center justify-between">
