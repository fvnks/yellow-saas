...
export default function AdminSettingsPage() {
 ...
 className="px-4 py-2 bg-cloud hover:bg-mist rounded-lg text-sm font-medium text-ink transition-colors"
 >
 ...
 type="submit"
 disabled={editSaving}
 className="px-4 py-2 bg-cloud hover:bg-mist rounded-lg text-sm font-medium text-ink transition-colors disabled:opacity-50"
 >
