...
import { formatCLP, formatDate, getStatusBadgeClass, getStatusLabel, getPriorityClass, getPriorityLabel } from '@/app/auto-talleres/lib/utils';

import { useAutoTalleresStore } from '@/app/auto-talleres/lib/auto-talleres-store';
const orders = [
 {
 id: 'OT-2024-001',
...
export default function OrdenesPage() {
 ...
 <div>
 <h1 className="text-2xl font-black text-monday-violet">Órdenes de Trabajo</h1>
