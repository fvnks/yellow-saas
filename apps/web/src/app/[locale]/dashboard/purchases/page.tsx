...
export default function PurchasesPage() {
 ...
 <div className="bg-card border border-border rounded-xl shadow-sm p-4 bg-primary border-border bg-primary border-border hover:bg-muted transition-colors cursor-pointer">
 <div className="flex flex-col items-center gap-2">
 <div className="w-10 h-10 bg-blue-50 rounded-xl flex items-center justify-center"><FileText className="w-5 h-5 text-primary" /></div>
 ...
 {/* Table */}
 {loading ? (
 <div className="bg-card border border-border rounded-xl shadow-sm p-8 bg-primary border-border">
 <div className="space-y-3">{[1, 2, 3, 4, 5].map(i => <div key={i} className="h-12 bg-muted rounded animate-pulse" />)}</div>
 </div>
 ) : filtered.length === 0 ? (
 <div className="bg-card border border-border rounded-xl shadow-sm p-12 bg-primary border-border text-center">
 ...
 <button onClick={() => setPage(p => Math.max(1, p - 1))} disabled={page === 1} className="px-3 py-1.5 bg-card border border-border rounded-lg text-sm font-medium text-foreground bg-card border-border text-foreground hover:bg-muted disabled:opacity-50 transition-colors">Anterior</button>
 ...
 <button onClick={() => setPage(p => Math.min(totalPages, p + 1))} disabled={page === totalPages} className="px-3 py-1.5 bg-card border border-border rounded-lg text-sm font-medium text-foreground bg-card border-border text-foreground hover:bg-muted disabled:opacity-50 transition-colors">Siguiente</button>
 </div>
 </div>
 </>
 )}
