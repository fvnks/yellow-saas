  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-bold text-foreground">Informes de Compra</h1>
          <p className="text-sm text-muted-foreground mt-1">Dashboard, reportes, análisis de precios y presupuestos</p>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-xl shadow-sm">
        ...
        <div className="p-6">
          ...
          {activeTab === 'reports' && <PurchaseReports />}
          {activeTab === 'price-history' && <SupplierPriceHistory />}
          {activeTab === 'contracts' && <SupplierContracts />}
          {activeTab === 'budgets' && <PurchaseBudgets />}
          {activeTab === 'forecast' && <PurchaseForecast />}
        </div>
      </div>
    </div>
  );
