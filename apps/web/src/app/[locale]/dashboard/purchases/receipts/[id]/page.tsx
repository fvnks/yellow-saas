...
export default function GoodsReceiptDetailPage({ params }: { params: { id: string } }) {
 ...
 <button className="mt-4 bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-4 py-2 rounded-lg text-sm font-medium transition-colors">
 ...
 <div className="space-y-6">
 <div className="bg-card border border-border rounded-xl shadow-sm sticky bg-primary border-border top-24">
 <div className="px-6 py-4 border-b border-border">
