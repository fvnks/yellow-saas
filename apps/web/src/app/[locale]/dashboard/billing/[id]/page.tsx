...
export default function InvoiceDetailPage() {
 ...
 <button onClick={handlePrint} className="bg-card border border-border hover:bg-muted text-foreground bg-card border-border hover:bg-primary/90 text-foreground px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors">
 ...
 className="bg-card border border-border hover:bg-red-50 text-red-600 bg-card border-border hover:bg-red-500/10 text-red-400 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors">
 ...
 <div className="bg-card border border-border rounded-xl shadow-sm p-4 bg-primary border-border">
 ...
 {invoice.notes && (
 <div className="bg-card border border-border rounded-xl shadow-sm p-6 bg-primary border-border">
