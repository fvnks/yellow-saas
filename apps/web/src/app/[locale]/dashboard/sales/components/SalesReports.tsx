...
export default function SalesReports() {
 ...
 <span className="text-[9px] font-semibold text-muted-foreground uppercase tracking-wider">Reportes de Venta</span>
 </div>
 <div className="flex items-center gap-2">
 ...
 <th className="text-left px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase">Mes</th>
 ...
 <th className="text-right px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase">Ticket Prom.</th>
 </tr>
 </thead>
 <tbody>
 {data.map((row: any) => (
 ...
 <th className="text-center px-4 py-3 text-[9px] font-semibold text-muted-foreground uppercase">Cantidad</th>
 </tr>
 </thead>
 <tbody>
 ...
 {data.length === 0 && (
 <tr><td colSpan={3} className="text-center py-8 text-xs text-muted-foreground">Sin datos</td></tr>
 )}
 </tbody>
 </table>
 </div>
