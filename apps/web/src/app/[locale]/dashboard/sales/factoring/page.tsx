          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl max-w-md w-full p-6 shadow-xl space-y-4">
            ...
            <form onSubmit={handleCede} className="space-y-3">
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                <button type="submit" className="px-4 py-2 bg-amber-500 hover:bg-[#EAB308] text-slate-950 font-semibold rounded-xl text-xs shadow-xs">Enviar AEC al SII</button>
              </div>
            </form>
          </div>
        </div>
