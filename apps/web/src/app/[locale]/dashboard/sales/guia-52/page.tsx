...
export default function Guia52Page() {
 ...
 <button type="submit" className="px-4 py-2 bg-monday-violet hover:bg-[#EAB308] text-slate-950 font-semibold rounded-xl text-xs shadow-xs">Timbrar DTE 52</button>
 </div>
 </form>
 </div>
 </div>
