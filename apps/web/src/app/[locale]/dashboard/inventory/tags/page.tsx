...
export default function TagsPage() {
 ...
 <p className="text-sm text-muted-foreground mt-1">Organiza tus productos con etiquetas de color</p>
 </div>
 </div>
 ...
 <button onClick={saveTag} className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
 ...
 <td className="px-4 py-3 text-xs font-medium text-foreground">{tag.name}</td>
 ...
 {tags.length === 0 && <div className="p-8 text-center text-sm text-muted-foreground">No hay tags registrados</div>}
 </div>
 )}
 </div>
 </div>
