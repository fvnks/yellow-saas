...
export default function NewInventoryCountPage() {
 ...
 <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl shadow-sm p-6 bg-primary border-border bg-primary border-border space-y-6">
