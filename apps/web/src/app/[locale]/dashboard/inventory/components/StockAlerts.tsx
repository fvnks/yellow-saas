...
export default function StockAlerts() {
 ...
 className="bg-card border border-border rounded-lg px-3 py-2 text-sm text-foreground focus:outline-none bg-card border-border text-white focus:ring-2 focus:ring-primary/20">
