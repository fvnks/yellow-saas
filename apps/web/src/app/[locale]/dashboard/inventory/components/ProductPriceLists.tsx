...
export default function ProductPriceLists() {
 ...
 className="flex-1 bg-card border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-card border-border text-white" />
 ...
 className="flex-1 bg-card border border-border rounded-lg px-3 py-1.5 text-xs focus:outline-none bg-card border-border text-white focus:ring-2 focus:ring-primary/20">
 ...
 className="w-28 bg-card border border-border rounded-lg px-3 py-1.5 text-xs focus:outline-none bg-card border-border text-white focus:ring-2 focus:ring-primary/20"
 placeholder="Precio" />
 <input type="number" value={newItem.min_quantity} onChange={e => setNewItem({ ...newItem, min_quantity: Number(e.target.value) })}
 min={1} className="w-20 bg-card border border-border rounded-lg px-3 py-1.5 text-xs focus:outline-none bg-card border-border text-white focus:ring-2 focus:ring-primary/20"
 placeholder="Min" />
