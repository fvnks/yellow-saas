...
export default function UomConversions() {
 ...
 <div key={productId} className="bg-card border border-border rounded-xl overflow-hidden bg-primary border-border">
 ...
 <div className="flex items-center gap-2">
 <span className="px-2 py-1 bg-card border border-border rounded text-xs bg-card border-border text-foreground font-medium text-foreground bg-card border-border text-foreground">{c.from_uom}</span>
 <ArrowRightLeft className="w-3.5 h-3.5 text-muted-foreground" />
 <span className="px-2 py-1 bg-card border border-border rounded text-xs bg-card border-border text-foreground font-medium text-foreground bg-card border-border text-foreground">{c.to_uom}</span>
