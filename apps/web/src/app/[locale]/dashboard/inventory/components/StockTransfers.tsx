...
export default function StockTransfers() {
 ...
 min={1} className="bg-card border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-card border-border text-white" placeholder="Cantidad" />
 <input type="text" value={form.notes} onChange={e => setForm({ ...form, notes: e.target.value })}
 className="bg-card border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 bg-card border-border text-white" placeholder="Notas (opcional)" />
 </div>
