    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <Link href="/select" className="flex items-center gap-3 px-2 py-3 rounded-xl hover:bg-sidebar-accent/50 transition-all duration-200 group">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 shadow-md shadow-slate-900/20 group-hover:shadow-lg group-hover:shadow-slate-900/30 transition-all duration-300 overflow-hidden">
            <Image src="/logo/yellow-cube.svg" alt="Yellow" width={28} height={28} />
          </div>
