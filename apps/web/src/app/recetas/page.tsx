...
export default function RecetasPage() {
 ...
 activeFilter === f.id ? 'bg-monday-violet text-[#0F172A] shadow-sm' : 'text-[#64748B] hover:bg-[#F1F5F9] hover:text-[#0F172A]'
 }`}>
 {f.label}
 </button>
 ))}
 ...
 <Link href="/recetas/new" className="bg-monday-violet text-white px-4 py-2 rounded-xl text-xs font-semibold hover:bg-[#1E293B] transition-colors inline-block">Crear primera receta</Link>
 </td></tr>
 ) : formulas.map(f => (
