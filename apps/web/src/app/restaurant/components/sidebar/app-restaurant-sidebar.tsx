...
export function RestaurantSidebar(props: React.ComponentProps<typeof Sidebar>) {
 ...
 className="mt-1 w-full bg-cloud border border-mist text-xs text-ink rounded-xl px-2.5 py-1.5 focus:outline-none focus:border-amber-500 transition-all cursor-pointer"
 >
 {users.map((u) => (
