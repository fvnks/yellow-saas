...
export default function AdminDashboard() {
 ...
 return (
 <div key={card.label} className="bg-cloud/80 border border-mist rounded-xl p-6 hover:border-violet-500/30 transition-colors">
 ...
 <div className="bg-cloud/80 border border-mist rounded-xl p-6">
