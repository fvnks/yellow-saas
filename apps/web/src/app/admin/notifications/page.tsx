...
export default function AdminNotificationsPage() {
 ...
 type="submit"
 disabled={saving}
 className="flex items-center gap-2 px-4 py-2 bg-cloud/80 hover:bg-slate-700 rounded-lg text-sm font-medium text-white transition-colors disabled:opacity-50"
 >
 ...
 {/* Filters */}
 <div className="bg-cloud/80 border border-border rounded-xl p-4 flex items-center gap-4">
 <div className="flex items-center gap-2">
 {[
