...
const MODULE_OPTIONS = [
 ...
 { id: 'accounting_pro', label: 'Contabilidad Pro', icon: Package, color: 'text-[#c64d00] bg-peach/30 border-peach' },
...
export default function AdminCompaniesPage() {
 ...
 <div className="bg-cloud/80 border border-mist rounded-xl p-4 flex items-center gap-4">
 ...
 <div className="bg-cloud/80 border border-mist rounded-xl overflow-hidden">
