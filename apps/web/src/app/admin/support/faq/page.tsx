...
export default function AdminFaqPage() {
 ...
 className="bg-cloud/80 hover:bg-mist text-ink px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors"
 >
 ...
 type="submit"
 disabled={saving}
 className="bg-cloud/80 hover:bg-mist text-ink px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors disabled:opacity-50"
 >
