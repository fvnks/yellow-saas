...
export default function AutoTalleresSidebarHeader() {
 ...
 className="p-1.5 rounded-lg hover:bg-cloud transition-colors"
 >
 ...
 {expanded && (
 <div className="mt-3 pt-3 border-t border-mist space-y-2">
 <Link
 href="/auto-talleres/orden-rapida"
 className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-400 hover:bg-cloud hover:text-ink transition-colors"
 >
 Orden Rápida
 </Link>
 <Link
