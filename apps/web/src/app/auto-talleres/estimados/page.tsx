...
export default function EstimadosPage() {
 ...
 <div>
 <h1 className="text-2xl font-black text-ink">Estimados</h1>
 ...
 <p className="text-2xl font-black text-ink">{estimates.length}</p>
 </div>
 </div>
 </div>
 <div className="bg-white border border-slate-200/80 rounded-2xl shadow-sm p-5">
 ...
 <p className="text-2xl font-black text-ink">1</p>
 </div>
 </div>
 </div>
 <div className="bg-white border border-slate-200/80 rounded-2xl shadow-sm p-5">
