...
function HRPageInner() {
 ...
 <h1 className="text-xl font-bold text-ink">Recursos Humanos</h1>
 ...
 <div className="animate-fade-in-up stagger-1 bg-white border border-mist rounded-2xl p-5 shadow-sm hover:border-rose-300 hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5">
 ...
 <div className="animate-fade-in-up stagger-2 bg-white border border-mist rounded-2xl p-5 shadow-sm hover:border-rose-300 hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5">
 <div className="flex items-center justify-between mb-2">
 ...
 <div className="animate-fade-in-up stagger-3 bg-white border border-mist rounded-2xl p-5 shadow-sm hover:border-rose-300 hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5">
 <div className="flex items-center justify-between mb-2">
 ...
 <div className="animate-fade-in-up stagger-4 bg-white border border-mist rounded-2xl p-5 shadow-sm hover:border-rose-300 hover:shadow-md transition-all duration-200 ease-out hover:-translate-y-0.5">
 <div className="flex items-center justify-between mb-2">
