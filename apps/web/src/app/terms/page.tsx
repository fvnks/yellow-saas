    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold text-slate-900">Terminos y Condiciones</h1>
          ...
          <div className="mt-10 space-y-8 text-sm text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">2. Descripcion del Servicio</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">3. Cuentas de Usuario</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">4. Suscripcion y Pagos</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">5. Propiedad Intelectual</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">6. Datos del Usuario</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">7. Disponibilidad del Servicio</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">8. Limitacion de Responsabilidad</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">9. Terminacion</h2>
              <p>
            ...
            <section>
              <h2 className="text-base font-semibold text-slate-900 mb-2">10. Ley Aplicable</h2>
              <p>
